...
/**
 * This class is for the chess piece King. 
 * 
 */
public class KingPiece extends StraightLineMovePiece {
 ...
 * 
 */
  public KingPiece(Side side, int row, int column, String label, Color color,
